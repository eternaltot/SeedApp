...
//            JSONObject jsonObject = new JSONObject(parsedString);
            ...
            String parsedString = "{\"Music\":{\"name\":\"คิดถึง - bodyslam\",\"tempo\":\"อาทิวราห์ คงมาลัย\",\"compose\":\"bodyslam, พูนศักดิ์ จตุระบุล\",\"lyrics\":\"มองดูเส้นทางที่ฉันเดินอยู่ จะมีใครรู้ใครเข้าใจ เรื่องราว ร้อยพัน ที่ฉันผ่านพบช่างมากมาย\n" +
