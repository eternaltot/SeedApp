...
import com.seedmcot.seedcave.add.model.MenuBarImageButton;
import com.seedmcot.seedcave.add.model.Music;
import com.seedmcot.seedcave.add.model.PlayAndNext;
import com.seedmcot.seedcave.add.view.AutoScrollViewPager;
import com.seedmcot.seedcave.add.view.DrawableManagerTT;
...
public class MainActivity extends FragmentActivity {
    ...
    public static String path_nowPlaying = "http://api.seedmcot.com/api/now-playings?fields=actual_date_time,event_type,link_title&expand=linkTitle,songTitle,songCover,linkCover,linkUrl,nowLyric,nowMv,nowAuthor,nowAuthor2,nowAuthor3,artistName";
...
//                    }
    ...
    public void setTypeFaceOther(Button button){
        if(button!=null){
            button.setTypeface(Typeface.createFromAsset(getAssets(),"Unicode_DBX_Helvethaica/db_helvethaica_x_ext_v3_2.ttf"));
        }
    }
